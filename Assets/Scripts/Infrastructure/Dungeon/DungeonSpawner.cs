...
namespace InGame.Infrastructure
{
    ...
    public class DungeonSpawner : MonoBehaviour
    {
        ...
        public async UniTask<DungeonData> Spawn(DungeonInformation dungeonCondition)
        {
            LoadStageTilePrefab();
        ...
        private async UniTask<DungeonData> CreateStageData(DungeonInformation dungeonCondition)
        {
        ...
        private void GenerateSection(SectionData sectionData, Vector2Int generatePoints, int sectionRange)
        {
            ...
            foreach (var grid in sectionData.GridDataArr)
            {
                ...
                if (gridTileObj != null)
                {
                    gridTileObj.transform.position = CalculateGenerateTilePosition(gridPosCount, firstGeneratePos, sectionRange);   
        ...
        private Vector3Int CalculateGenerateTilePosition(int sectionsGridPos, Vector2Int leftBottomPos, int sectionRange)
        {
