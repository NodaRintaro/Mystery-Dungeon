...
namespace Infrastructure
{
    public class CharacterRepositry
    {
        ...
        private CharacterGameObjectHolder _characterVisualDataHolder = null;
        ...
        private bool TryCreateCharacter(int characterID, out CharacterPrefabData characterVisualData, out CharacterData characterData)
        {
        ...
        private async UniTask LoadData()
        {
            ...
            _characterVisualDataHolder = await assetsLoader.LoadAssetAsync<CharacterGameObjectHolder>(_characterAssetsPath);
        }

        private bool TryGetVisualData(int characterID, out CharacterPrefabData data)
        {
