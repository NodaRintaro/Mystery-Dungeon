...
namespace Infrastructure
{
    public class CharacterRepositry
    {
        ...
        private CharacterAssetDataHolder _characterVisualDataHolder = null;
        ...
        public bool TryCreateCharacter(int characterID, out CharacterAssetData characterVisualData, out CharacterData characterData)
        {
        ...
        private async UniTask LoadData()
        {
            ...
            _characterVisualDataHolder = await assetsLoader.LoadAssetAsync<CharacterAssetDataHolder>(_characterAssetsPath);
        }

        private bool TryGetVisualData(int characterID, out CharacterAssetData data)
        {
