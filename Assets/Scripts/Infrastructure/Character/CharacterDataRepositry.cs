...
{
    public class CharacterDataRepositry
    {
        ...
        private CharacterViewDataHolder _characterVisualDataHolder = null;
        ...
        private bool TryCreateCharacter(int characterID, out CharacterViewData characterVisualData, out CharacterData characterData)
        {
        ...
        private async UniTask LoadData()
        {
            ...
            _characterVisualDataHolder = await assetsLoader.LoadAssetAsync<CharacterViewDataHolder>(_characterAssetsPath);
        }

        private bool TryGetVisualData(int characterID, out CharacterViewData data)
        {
            data = _characterVisualDataHolder.GetCharacterViewData(characterID);
        ...
        private bool TryGetCharacterData(int characterID, out CharacterData characterData)
        {
            ...
            //            // 繧ｭ繝｣繝ｩ繧ｯ繧ｿ繝ｼ縺ｮ繧ｹ繝・・繧ｿ繧ｹ繧辰SV縺九ｉ蜿門ｾ励＠縺ｦCharacterStatus繧ｯ繝ｩ繧ｹ縺ｮ繧､繝ｳ繧ｹ繧ｿ繝ｳ繧ｹ繧堤函謌・
            //            new CharacterStatus
            //            (
            //                id,
            //                _characterDataCSV[i, 1],
            ...
            //            // 繧ｭ繝｣繝ｩ繧ｯ繧ｿ繝ｼ縺ｮ謌宣聞譖ｲ邱壹ｒCSV縺九ｉ蜿門ｾ励＠縺ｦCharacterGrowthRates繧ｯ繝ｩ繧ｹ縺ｮ繧､繝ｳ繧ｹ繧ｿ繝ｳ繧ｹ繧堤函謌・
