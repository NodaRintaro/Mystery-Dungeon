...
public class ObjectPool
{
    ...
    private Dictionary<int, List<GameObject>> _poolDict = new();

    /// <summary> プールの初期化 </summary>
    public void InitPool()
    {
        _poolDict = new Dictionary<int, List<GameObject>>();
    }
    ...
    /// <summary> 指定したオブジェクトを全て非表示にする </summary>
    public void ReleaseAllObjects()
    {
        foreach (var poolList in _poolDict.Values)
        {
    ...
    public void ReleaseObject(GameObject go) => go.SetActive(false);
