...
public class DungeonGenerator : MonoBehaviour
{
    ...
    [SerializeField] private DungeonTilePool _dungeonObjectHolder = new();
    ...
    private GameObject SpawnTileObj(TileType tileType)
    {
        ...
        {
            GameObject tileObject = _dungeonObjectHolder.TileObjectPool.SpawnObject(_dungeonObjectHolder.TileObjectDict[tileType]);
            return tileObject;
        }
        else
        {
            GameObject tileObject = _dungeonObjectHolder.TileObjectPool.SpawnObject(_dungeonObjectHolder.TileObjectDict[TileType.Wall]);
            return tileObject;
        }
        return null;
    }
