...
namespace Roguelike.Dungeon.System
{
    ...
    public class StageGenerator : MonoBehaviour
    {
        ...
        [SerializeField] private StageTileObjectPool _tileObjectPool = new();

        private readonly StageBuilder _stageBuilder = new();
        ...
        public async UniTask<StageData> GenerateStage()
        {
            LoadStageTilePrefab();
            StageData dungeonData = await CreateStageData();
            ...
            for (int x = 0; x < _horizontalSectionsNum; x++)
            {
                for (int y = 0; y < _verticalSectionsNum; y++)
                {
                    ...
                    GenerateSection(dungeonData.StageSectionsData[x, y], generatePoints);
                }
            }
        ...
        private async UniTask<StageData> CreateStageData()
        {
